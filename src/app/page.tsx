...
export default function Home() {
  ...
  <nav className="bg-white py-2 md:py-4">
    <div className="container px-4 mx-auto md:flex md:items-center">
      ...
      <div className=" flex- md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
        ...
        <a href="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-900">Pricing</a>
